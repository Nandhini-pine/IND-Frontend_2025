  ...
  const checkDataAndNotify = async () => {
    ...
    if (patientDetails) {
      ...
      await Promise.all([
        ...
        checkData(`https://indheart.pinesphere.in/patient/patient/${storedPhoneNumber}/vegdiet-data/`, "veg diet", "VegDietPage"),  // Using phone number
        checkData(`https://indheart.pinesphere.in/patient/patient/${storedPhoneNumber}/nonvegdiet-data/`, "non-veg diet", "NonVegDietPage"), // Using phone number
